...
namespace programe1
{
    ...
    public class Order
    {
        ...
        public Order()                                         //构造函数 
        {
            ...
            MyOrderDateTime = new OrderDateTime();
            ClientName = "";
            OrderNum = "";
            AllPrice = 0;
        }
        ...
        {
            Order.orderCount++;
            MyOrderDateTime = new OrderDateTime(DateTime.Now);
            OrderNum = MyOrderDateTime.Year.ToString() + "-" + MyOrderDateTime.Month.ToString() + "-" + MyOrderDateTime.Day.ToString() + "-" + orderCount.ToString();
            //初始化订单明细 
            AllPrice = 0;
        }
